package se.thefarm.acra.senders;
...
import se.thefarm.SentryHandler;
import se.thefarm.objects.Report;
import se.thefarm.objects.Exception;
...
public class SentrySender implements ReportSender {
    ...
    private String buildJSON(CrashReportData crashReportData) throws JSONException {
        ...
        sentryReport.setMessage(throwable.getMessage());

        /* Add the exceptions and determine the culprit */
        List<se.thefarm.objects.Exception> exceptions = new ArrayList<Exception>();
        String culprit = "";
